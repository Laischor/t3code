...
export const PREVIEW_OPEN_DEVTOOLS_DOCKED_CHANNEL = "desktop:preview-open-devtools-docked";
export const PREVIEW_SET_DEVTOOLS_BOUNDS_CHANNEL = "desktop:preview-set-devtools-bounds";
export const PREVIEW_CLOSE_DEVTOOLS_CHANNEL = "desktop:preview-close-devtools";
